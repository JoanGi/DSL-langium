...
const second_module_1 = require("../language-server/second-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const model = yield (0, cli_util_1.extractAstNode)(fileName, module_1.languageMetaData.fileExtensions, (0, second_module_1.createSecondServices)());
